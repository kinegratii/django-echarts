...
echarts库引用链接改用支持版本化的仓库，支持按echarts版本引用。


| 依赖库             | pycharts 1.9 | pycharts2.0 | 仓库源 |
| ------------------ | ------------ | ----------- | ------ |
| echarts            | 4.8.0        | 5.4.0       | cdnjs  |
| echarts-gl         | 1.1.2        | 2.0.8       | cdnjs  |
| echarts-wordcloud  | 1.1.3        | 2.1,0       | unpkg  |
| echarts-liquidfill | 2.0.6        | 3.1.0       | unpkg  |
